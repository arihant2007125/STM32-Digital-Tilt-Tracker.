...
void ssd1306_Init(void) {
    ...
    // Set Contrast
      ...
      ssd1306_WriteCommand(0xFF); // --set maximum contrast (0xFF = brightest)

      // Turn on Charge Pump (Crucial for clones)
      ssd1306_WriteCommand(0x8D); // --set charge pump setting
      ssd1306_WriteCommand(0x14); // --enable charge pump (0x10 would disable it for external VCC)

      // Turn on Display Panel
